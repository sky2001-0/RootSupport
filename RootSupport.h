...
namespace rs
{
  ...
  namespace file
  {
    ...
    std::unique_ptr<TDirectory> MakeDir(
      ...
      const std::unique_ptr<TDirectoryLike>& dir
    )
    {
    ...
    std::unique_ptr<TObjectLike> GetObj(
      const Char_t* name,
      const std::unique_ptr<TDirectoryLike>& dir
    )
    {
  ...
  namespace graph
  {
    ...
    template <typename TGraphLike>
    std::unique_ptr<TGraphLike> Create(
      const std::unique_ptr<const TGraphLike>& g
    )
    {
    ...
    template <typename TGraphLike>
    void SortX(const std::unique_ptr<TGraphLike>& g)
    {
      rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    template <typename TGraphLike>
    void SetColor(const Color_t color, const std::unique_ptr<TGraphLike>& g)
    {
      rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    // template <typename TGraphLike>
    // void ScaleX(const Double_t factor, const std::unique_ptr<TGraphLike>& g)
    // {
    //   rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    // template <typename TGraphLike>
    // void ScaleY(const Double_t factor, const std::unique_ptr<TGraphLike>& g)
    // {
    //   rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    // template <typename TGraphLike>
    // void MovePoints(
    //   const Double_t x_move,
    //   const Double_t y_move,
    //   const std::unique_ptr<TGraphLike>& g
    // )
    // {
    //   rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    template <typename TGraphLike>
    void InvertX(const std::unique_ptr<TGraphLike>& g)
    {
      rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    template <typename TGraphLike>
    void PushGraph(
      const std::unique_ptr<const TGraphLike>& g_pushed,
      const std::unique_ptr<TGraphLike>& g
    )
    {
      rss::Assert_if_is_inheritance_of_TGraph<TGraphLike>();
    ...
    inline std::unique_ptr<TGraph> FetchErrYGraph(
      const std::unique_ptr<const TGraphErrors>& g
    )
    {
  ...
  namespace draw
  {
    // inline void SetLogX(const std::unique_ptr<TCanvas>& c)
    // {
    //   c->SetLogx();
    // }


    // inline void SetLogY(const std::unique_ptr<TCanvas>& c)
    // {
    //   c->SetLogy();
    // }
    ...
    inline void DrawLine(
      const std::unique_ptr<TCanvas>& c,
